...
function preload() {
  	...
  	asteroid_image = loadImage("asteroid.jpg");
  	laser_image = loadImage("laser.jpg");
  	gameover_image = loadImage("gameover.jpg");
  	restart_image = loadImage("restart.jpeg");
}
...
function spawn_laser() {
	laser = createSprite(shuttle.x,shuttle.y,10,10);
	laser.addImage(laser_image);
	laser.scale = 0.1;
	laser.depth = shuttle.depth - 1;
	laser.velocityX = 12.5;
